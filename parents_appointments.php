...
<div class="pt-32 pb-20 px-6 md:px-20 max-w-[1400px] mx-auto flex-grow w-full fade-in">
    ...
    <div class="flex flex-col md:flex-row justify-between items-end gap-6 mb-10">
        ...
        <a href="parents_hospitals.php" class="px-6 py-3 bg-darkblue text-white rounded-xl font-bold shadow-lg shadow-blue-900/20 hover:bg-cyan-500 transition flex items-center gap-2 text-sm group">
